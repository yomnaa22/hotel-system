                ...
                <tr>
                  ...
                  <td><img src='{{ asset("uploads/manager/$manager->avatar_img") }}'' width="50" height="50" alt=""></td>
                    ...
                    <td>
                     ...
                     <form method="get" action="{{ route('manager.edit',$manager->id)}}" class="d-inline">
                      @csrf
                      <button class="btn btn-none"><i class="fas fa-edit text-primary"></i></button>
                    </form>
                    <form method="post" action="{{ route('manager.delete',$manager->id)}}" class="d-inline">
                      @csrf
                      @method(' delete') <button class="btn btn-none"><i class="fas fa-trash-alt text-danger"></i></button>
                    </form>
                  </td>
                </tr>
                @endforeach
