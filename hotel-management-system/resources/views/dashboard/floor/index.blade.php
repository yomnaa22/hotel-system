            ...
            <table id="example2" class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  @if(Auth::guard('manager')->user()->id==$floor->manager_id)
                  <td>

                    <form method="get" action=" /edit/{{ $floor-> id }} " class="d-inline">
                      @csrf
                      <button class="btn btn-none"><i class="fas fa-edit text-primary"></i></button>
                    </form>
                    <form method="post" action="{{ route('floor.delete', ['id' => $floor->id]) }}" class="d-inline">
                      @csrf
                      @method('delete')
